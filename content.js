$(document).ready(function(){
	...
	var imageSource=[
		{url: "./memes/midlife_crisis1.jpg"},
		{url: "./memes/school_1.jpg"},
		{url: "./memes/work_1.jpg"}
	];
	var quoteSource=[
	{
	...
	$('#quoteButton').click(function(evt){
		...
		var randNum= Math.floor(Math.random()*(imageSource.length));
		//set a new quote
		for(i=0;i<=sourceLength;i+=1){
			...
			img.src= imageSource[randNum].url;
			//var src = document.getElementById("ig1");
			src.appendChild(img);
